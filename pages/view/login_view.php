...
function errorMessage()
{
    if (isset($_SESSION['login_error'])) {
        ...
        foreach ($errors as $error) {
            $error_message = "<div style=\"width: 735px;margin: 20px auto;padding: 5px; background-color:red;color:white;\" align=\"center\" class=\"alert\">";
            $error_message .= $error;
            $error_message .= "</div>";
            echo $error_message;
        }
...
function successMessage()
{
    if (isset($_SESSION["login_success"])) {
        ...
        $message = "<p style=\"width: 735px;margin: 20px auto;padding: 5px; background-color:green; color:white;\" align=\"center\">";
